...
public class OrangeTreeWorldGeneration extends WorldGenerator implements IWorldGenerator{
...
private final int metaLeaves;
	...
	public OrangeTreeWorldGeneration(boolean par1){
		this(par1,8,0,0,false);
	}
	
	public OrangeTreeWorldGeneration(boolean par1, int par2, int par3, int par4, boolean par5){
		super(par1);
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (OrangeSappling)Cookies.orangeSappling));
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, Cookies.orangeLog.blockID, this.metaWood);
	...
	private void growVines(World par1World, int par2, int par3, int par4, int par5 ) {
		...
		while(true){
			...
			if(par1World.getBlockId(par2, par3, par4)!= 0 || il<=0){
				return;
			}
			this.setBlockAndMetadata(par1World, par2, par3, par4, Block.vine.blockID, par5);
			--il;
